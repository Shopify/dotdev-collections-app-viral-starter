...
export async function enableVariantDrop(_opts: {
  ...
  throw new Error(
    "variant_drop is not implemented yet — use the Step 7 coding prompt, then Mark as done.",
  );
}
...
export async function disableVariantDrop(_opts: {
  ...
  // No-op until Step 7 is implemented. `graphql` is passed so your teardown can
